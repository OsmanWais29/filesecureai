      ...
      <div className="h-full flex flex-col border-l bg-background">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center text-muted-foreground">
            ...
            <p className="text-sm mt-2">Choose a document from the list to see its details</p>
          </div>
        </div>
      </div>
    );
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-3">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">{formatDate(document.created_at).split(' at ')[0]}</span>
                </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">{formatDate(document.updated_at).split(' at ')[0]}</span>
                </div>
