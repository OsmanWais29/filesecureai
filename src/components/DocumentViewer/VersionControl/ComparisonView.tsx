    ...
    <Card className="mt-4">
      ...
      <CardContent className="space-y-4 text-sm">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <h3 className="font-medium mb-2">Current Version ({currentVersion.versionNumber})</h3>
            <p className="text-muted-foreground text-xs">
              Created on {formatDate(currentVersion.createdAt)}
            </p>
            <p className="mt-1">{currentVersion.description || "No description provided."}</p>
          </div>
          <div>
            <h3 className="font-medium mb-2">Previous Version ({previousVersion.versionNumber})</h3>
            <p className="text-muted-foreground text-xs">
              Created on {formatDate(previousVersion.createdAt)}
            </p>
        ...
        <div>
          ...
          <p>{currentVersion.changesSummary || "No changes summary provided."}</p>
        </div>
      </CardContent>
    </Card>
  );
